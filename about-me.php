...
<body>
  <div class="about-wrap">
    ...
    <div class="prose">
      ...
      <p>Throughout my career, I've built a reputation for making complicated things simple. That's exactly what I set out to do with these calculators: useful tools, plain English, no jargon—and free to use. A <strong><a href="https://ronbelisle.com/premium.html">Premium</a></strong> option adds more for people who want to go deeper: save and compare scenarios, export PDF and CSV reports, run longer projections where a calculator supports them, and get <strong>AI-generated plain-English explanations</strong> tailored to <em>your</em> inputs and results—so you can see what the numbers mean in context. The core tools still cost nothing. I hope you find them valuable.</p>
    </div>
  </div>
