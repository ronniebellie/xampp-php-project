...
<head>
  ...
  <style>
    @media (max-width: 700px) {
      ...
      .debt-row label { font-size: 12px !important; }
    }
  </style>
</head>
<body>
  ...
  <div class="wrap">
    ...
    <header>
      ...
      <p class="sub">Compare avalanche vs snowball, see payoff timelines, and how extra payments save interest.</p>
    </header>

    <div class="info-box-blue" style="margin-bottom: 30px;">
      <h2>Two strategies</h2>
      <p><strong>Avalanche</strong> — Put extra money toward the debt with the highest interest rate first. You pay less total interest. <strong>Snowball</strong> — Put extra toward the smallest balance first so you knock out accounts sooner and build momentum. Both work; choose what keeps you motivated.</p>
    </div>
...
<?php endif; ?>
    ...
    <form id="debtForm">
      <h3>Your debts</h3>
      <p style="color: #64748b; margin-bottom: 15px;">Enter up to 5 debts. Leave balance at 0 to skip.</p>
      <div id="debtRows">
        <div class="debt-row" style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr auto; gap: 12px; align-items: end; margin-bottom: 12px;">
          <div>
            ...
            <input type="text" id="name1" placeholder="e.g. Credit card" style="width: 100%; padding: 8px; border: 1px solid #e5e7eb; border-radius: 8px;">
          </div>
          <div>
    ...
    $premium_upsell_text = 'Upgrade to Premium to save and compare debt payoff scenarios, export PDF and CSV reports, and get AI-generated plain-language explanations of your specific results.';
