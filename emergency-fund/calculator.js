...
document.getElementById('efForm').addEventListener('submit', function(e) {
  ...
  if (currentSavings >= result.target) {
    ...
    progressEl.textContent = 'You\'re ' + Math.round((currentSavings / result.target) * 100) + '% of the way to your goal. At $' + monthlyContribution + '/month, you\'ll reach it in ' + result.monthsToGoal + ' months.';
