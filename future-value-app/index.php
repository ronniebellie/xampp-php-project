...
<head>
  <?php include("../includes/analytics.php"); ?>
    ...
    <meta name="description" content="Calculate present value, future value, annuities, and required payments. Lump sum growth, monthly savings to goal, and compound interest.">
    <title>Future Value Calculator</title>
    <?php $og_title = $ld_name = 'Future Value Calculator'; $og_description = $ld_description = 'Calculate present value, future value, annuities, and required payments. Lump sum growth, monthly savings to goal, and compound interest.'; include(__DIR__ . '/../includes/og-twitter-meta.php'); include(__DIR__ . '/../includes/json-ld-softwareapp.php'); ?>
...
<?php endif; ?>
        ...
        $premium_upsell_text = 'Upgrade to Premium to save and compare scenarios, export PDF and CSV reports, and get AI-generated plain-language explanations of your specific results.';
