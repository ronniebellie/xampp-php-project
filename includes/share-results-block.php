...
<div class="share-results" id="shareResults" style="margin-top: 28px; padding-top: 20px; border-top: 1px solid #e2e8f0; text-align: center;"<?php echo $share_attr; ?>>
    ...
    <label style="display:block; margin-bottom:12px;"><input type="checkbox" id="shareIncludeInputs"> Include available input assumptions in the link. Anyone receiving it, including the selected sharing service, can read them.</label>
    <div style="display: flex; flex-wrap: wrap; gap: 10px; justify-content: center; align-items: center;">
        ...
        <span id="shareCopyFeedback" role="status" aria-live="polite" style="font-size: 14px; color: #38a169;"></span>
