...
<body>
            ...
            <div class="container phase-template-grid">
                <div class="phase-main-column">
                    <div class="phase-intro">
                        ...
                        <p class="page-lede">Estimate the monthly spending your retirement lifestyle will require. Use estimates where needed. You can update this plan later.</p>
                        <div class="phase-status-note" role="note">
                            <p>Spending includes expenses such as housing, food, transportation, healthcare, insurance, utilities, travel, entertainment, charitable giving, and similar household costs. Do not include federal income taxes, savings, or investment contributions.</p>
                        </div>
                    </div>
                    ...
                    <form class="planning-panel journey-calculator" id="retirementSpendingPlanForm" novalidate>
                        ...
                        <section class="calculator-section" data-method-section="monthly_estimate" hidden aria-labelledby="monthly-title">
                            <p class="eyebrow">Step 2</p>
                            <h2 id="monthly-title">Current monthly household spending</h2>
                            <div class="field-group field-group-wide">
                                ...
                                <small>Enter your best estimate of what your household spends in a typical month today. The number does not need to be perfect.</small>
                            </div>
                        </section>
                ...
                <aside class="phase-sidebar-column">
                    ...
                    <div class="next-step-card">
                        ...
                        <p>This planner saves one active retirement spending plan for Phase 1. You can update it later as your assumptions become clearer.</p>
    ...
    <script src="/assets/js/retirement-spending-plan.js?v=20260729-approaching-retirement" defer></script>
</body>
</html>
