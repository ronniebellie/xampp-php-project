/**
 * Provisional Phase 4 stress-test engine for calibration only.
 * Numbers and classification rules are working hypotheses — not product locks.
 */
(function (global) {
    'use strict';
    ...
    global.Phase4ProvisionalEngine = {
        IMPACT: IMPACT,
