...
$strings = [
  'en' => [
    ...
    'section_subtitle' => 'Start with any calculator below. Each page explains the idea in clear English and uses yen (¥) in the examples. You can switch the currency to $ anytime.',
