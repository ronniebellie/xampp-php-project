...
<body>
  ...
  <div class="wrap">
    ...
    <div class="info-box-blue" style="margin-bottom: 30px;">
      ...
      <p style="margin-top: 12px;"><strong>Tip:</strong> There&rsquo;s no single &ldquo;correct&rdquo; expected return&mdash;treat it as an assumption to test. If you&rsquo;re unsure where to start, for a balanced portfolio (roughly 60&ndash;70% stocks and 30&ndash;40% bonds), try 5%, 6%, and 7% and compare the results. Include volatility (for example, a 10&ndash;15% standard deviation) to reflect sequence-of-returns risk. Because the simulation updates instantly, comparing scenarios takes just a click.</p>
    </div>
