...
<head>
  ...
  <meta name="description" content="Pay off student loans faster. Model payoff timeline, extra payments, and refinancing. Compare standard vs income-driven plans.">
  <title>Student Loan Payoff Calculator</title>
  <?php $og_title = $ld_name = 'Student Loan Payoff Calculator'; $og_description = $ld_description = 'Pay off student loans faster. Model payoff timeline, extra payments, and refinancing. Compare standard vs income-driven plans.'; include(__DIR__ . '/../includes/og-twitter-meta.php'); include(__DIR__ . '/../includes/json-ld-softwareapp.php'); ?>
...
<?php endif; ?>
    ...
    <form id="loanForm">
      ...
      <div id="loanRows">
        <div class="loan-row" style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr auto; gap: 12px; align-items: end; margin-bottom: 12px;">
          ...
          <div>
            ...
            <input type="number" id="balance1" min="0" step="any" value="25000" style="width: 100%; padding: 8px; border: 1px solid #e5e7eb; border-radius: 8px;">
          </div>
          <div>
            <label for="apr1" style="display: block; margin-bottom: 4px; font-weight: 600; font-size: 13px;">APR (%)</label>
            <input type="number" id="apr1" min="0" max="50" step="any" value="5.5" style="width: 100%; padding: 8px; border: 1px solid #e5e7eb; border-radius: 8px;">
          </div>
          <div>
            <label for="min1" style="display: block; margin-bottom: 4px; font-weight: 600; font-size: 13px;">Min payment ($)</label>
            <input type="number" id="min1" min="0" step="any" value="280" style="width: 100%; padding: 8px; border: 1px solid #e5e7eb; border-radius: 8px;">
          </div>
          <div></div>
        </div>
        <div class="loan-row" style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr auto; gap: 12px; align-items: end; margin-bottom: 12px;">
          ...
          <div><label for="balance2" style="display: block; margin-bottom: 4px; font-weight: 600; font-size: 13px;">Balance ($)</label><input type="number" id="balance2" min="0" step="any" value="18000" style="width: 100%; padding: 8px; border: 1px solid #e5e7eb; border-radius: 8px;"></div>
          <div><label for="apr2" style="display: block; margin-bottom: 4px; font-weight: 600; font-size: 13px;">APR (%)</label><input type="number" id="apr2" min="0" max="50" step="any" value="4.2" style="width: 100%; padding: 8px; border: 1px solid #e5e7eb; border-radius: 8px;"></div>
          <div><label for="min2" style="display: block; margin-bottom: 4px; font-weight: 600; font-size: 13px;">Min payment ($)</label><input type="number" id="min2" min="0" step="any" value="180" style="width: 100%; padding: 8px; border: 1px solid #e5e7eb; border-radius: 8px;"></div>
          <div></div>
        </div>
        <div class="loan-row" style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr auto; gap: 12px; align-items: end; margin-bottom: 12px;">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 15px; margin-bottom: 25px;">
        ...
        <div>
          ...
          <input type="number" id="extra" min="0" step="any" value="100" style="width: 100%; padding: 10px; border: 1px solid #e5e7eb; border-radius: 8px;">
    ...
    $premium_upsell_text = 'Upgrade to Premium to save and compare student loan payoff scenarios, export PDF and CSV reports, and get AI-generated plain-language explanations of your specific results.';
