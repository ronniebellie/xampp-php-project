...
<head>
    ...
    <?php $ld_name = 'Present Value of an Annuity'; $ld_description = 'Calculate present value of an annuity. Value a stream of equal payments discounted to today.'; include(__DIR__ . '/../../includes/json-ld-softwareapp.php'); ?>
